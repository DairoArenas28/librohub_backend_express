...
import { getAll, getMe, createUser, updateUser, removeUser, uploadAvatar, getAvatar, getAvatarBase64Json } from './users.controller';
...
router.get('/:id/avatar/base64', authMiddleware, getAvatarBase64Json);
